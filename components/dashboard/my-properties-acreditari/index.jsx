...
const index = ({ oferte, an }) => {
  ...
  const {
    ...
    currentPage,
  } = useDataWithPaginationAndSearchAcreditari(filteredData, "numar");
  ...
  const applyFilters = (data, filters, search) => {
    ...
    if (search) {
      filtered = filtered.filter(item => 
        item.numar?.toString().includes(search) ||
              ...
              <div className="row">
                ...
                <div className="col-lg-4 col-xl-4 mb10">
                  <div className="breadcrumb_content style2 mb30-991">
                    <h2 className="breadcrumb_title">Lista Acreditari {an}</h2>
                    <p>Total: {filteredData.length} acreditări</p>
                    <button 
